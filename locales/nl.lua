...
Locales['nl'] = {
    ...
    --
    ['press_boat_message'] = "Druk [%s] om de boot vast te zetten",
    ['press_other_message'] = "Druk [%s] om het voertuig vast te zetten",
    ['press_to_park'] = "Druk [%s] om het voertuig te parkeren",
    --
